...
export const AGENT_OPTIONS: AgentOption[] = [
  {
    ...
    specialty: "Client Requirements & Solution Guidance",
    description: "Friendly, lively, and super-welcoming AI virtual assistant for ANX Agency.",
    color: "text-purple-400",
    bgColor: "bg-purple-950/40",
    borderColor: "border-purple-500/40",
    accentHex: "#c084fc",
    icon: Sparkles,
    welcomeMessage: "Main Anya hoon, ANX Agency ki virtual assistant. Main aapki requirement samajhne aur suitable solution dhoondhne mein help karungi.",
